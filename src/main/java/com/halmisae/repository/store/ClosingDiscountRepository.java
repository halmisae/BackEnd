...
//    @Query("SELECT new com.halmisae.dto.store.ClosingDcAndFoodDTO(cd.storeNumber, cd.closingPrice, cd.pickupTime) FROM ClosingDiscount cd WHERE cd.storeNumber = :ocd")
